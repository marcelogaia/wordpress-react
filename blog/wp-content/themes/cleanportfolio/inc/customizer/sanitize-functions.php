<?php
/**
 * Clean Portfolio Theme Options Sanitization Functions
 *
 ...
 */
function cleanportfolio_sanitize_select( $input, $setting ) {
 ...
 */
function cleanportfolio_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function cleanportfolio_sanitize_post( $input ) {
 ...
 */
function cleanportfolio_sanitize_image( $image, $setting ) {
    /*
 ...
 */
function cleanportfolio_sanitize_category_list( $input ) {
    if ( '' != $input ) {
        if( in_array( 0, $input ) ) {
            return '0';
        }
 ...
 *                    the setting default.
 */
function cleanportfolio_sanitize_number_range( $number, $setting ) {
