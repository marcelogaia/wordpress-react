...
if ( ! function_exists( 'perfect_portfolio_customizer_theme_info' ) ) :
	...
	function perfect_portfolio_customizer_theme_info( $wp_customize ) {
		...
		$theme_info .= sprintf( '%1$s<a href="%2$s" target="_blank">%3$s</a>', esc_html__( 'Demo Link : ', 'perfect-portfolio' ), esc_url( __( 'https://demo.raratheme.com/perfect-portfolio/', 'perfect-portfolio' ) ), esc_html__( 'Click here.', 'perfect-portfolio' ) );

	    $theme_info .= '</p><p>';

	    /* translators: 1: string, 2: documentation url, 3: string */
	    $theme_info .= sprintf( '%1$s<a href="%2$s" target="_blank">%3$s</a>', esc_html__( 'Documentation Link : ', 'perfect-portfolio' ), esc_url( 'https://raratheme.com/documentation/perfect-portfolio/' ), esc_html__( 'Click here.', 'perfect-portfolio' ) );
	...
	$manager->add_section(
		new Perfect_Portfolio_Customize_Section_Pro(
			...
			array(
				...
				'pro_url'  => 'https://raratheme.com/wordpress-themes/perfect-portfolio-pro/'
			)
		)
	);
}