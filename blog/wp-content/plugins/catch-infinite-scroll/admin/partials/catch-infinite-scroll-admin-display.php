    ...
    <div class="catchp-content-wrapper">
        <div class="catchp_widget_settings">
            ...
            <h2 class="nav-tab-wrapper">
                ...
                <a class="nav-tab" id="premium-extensions-tab" href="#premium-extensions"><?php esc_html_e( 'Premium/Extensions', 'catch-infinite-scroll' ); ?></a>
            </h2>
            ...
            <div id="premium-extensions" class="wpcatchtab  save">
                ...
                <div class="content-wrapper">
                    <div class="header">
                        <h3><?php esc_html_e( 'Premium/Extensions', 'catch-infinite-scroll' ); ?></h3>
