...
class Raratheme_Companion {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_filter( 'template_include', $plugin_admin, 'rrtc_include_template_function' );
		$this->loader->add_action( 'wp_loaded', $plugin_admin, 'rrtc_add_portfolio_templates' );
