    ...
    */
    function rtc_social_template() { ?>
        <div class="rtc-social-template">
            <li class="rtc-social-icon-wrap" data-id={{indexes}}>
                ...
                <span class="rtc-social-links-field-handle dashicons dashicons-plus"></span>
                ...
                <label class="link-label" for="<?php echo esc_attr( $this->get_field_id( 'social_profile[{{indexes}}]' ) ); ?>"><?php esc_html_e( 'Link', 'raratheme-companion' ); ?></label>
                ...
                <span class="del-rtc-icon dashicons-no" style="font-family: 'dashicons'"></span>
            </li>
        </div>
    <?php
    echo '<style>
                ...
                <?php
                    ...
                    { 
                        ...
                        { 
                            ...
                            if( in_array( $this->rtc_get_social_icon_name( $instance['social'][$value] ), $allowed_socicon ) )
                            {
                            ?>
                            <li class="rtc-social-icon-wrap">
                                <a <?php if(isset($instance['target']) && $instance['target']=='1'){ echo "target=_blank"; } ?> href="<?php echo esc_url($instance['social'][$value]);?>"><span class="rtc-social-links-field-handle fa fa-<?php echo esc_attr($icon);?>" style="font-family: 'FontAwesome';"></span></a>
                            </li>
                        <?php
                            }
                        }
    ...
    function rtc_get_social_icon_name( $url ) {
        ...
        if ( $url = strtolower( $url ) ) {
            ...
            if ( ! $icon ) {
                foreach ( $this->rtc_allowed_socicons() as $icon_name ) {
                    ...
                    { 
                        ...
                        ?>
                            <li class="rtc-social-icon-wrap" data-id="<?php echo $value;?>">
                                    <span class="btab-social-links-sortable-handle"></span>
                                    <span class="rtc-social-links-field-handle fa fa-<?php echo esc_attr( $icon )?>" style="font-family: 'FontAwesome'"></span>
                                    <label for="<?php echo esc_attr( $this->get_field_id( 'social_profile['.$value.']' ) ); ?>"><?php esc_html_e( 'Social Icon', 'raratheme-companion' ); ?></label>
                                    <span class="example-text">Example: facebook</span>
                                    <input class="user-social-profile" id="<?php echo esc_attr( $this->get_field_id( 'social_profile['.$value.']' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'social_profile['.$value.']' ) ); ?>" type="text" value="<?php echo esc_attr($this->rtc_get_social_icon_name($instance['social'][$value]));?>" />
