                    ...
                    if( $content ) echo wpautop( wp_kses_post( $content ) );                
                        if( isset($fimg_url) && $fimg_url!='' ){ ?>
                            <div class="image-holder">
                                <?php
                                    echo '<a href="'.esc_url($link).'" target="_blank"><img src="'.esc_url( $fimg_url ).'" alt="'.esc_html( $title ).'" /></a>';
                                ?>
                            </div>
                        <?php
                        }
                        if( isset($link) && $link!='' && $label ) echo '<a href="'.esc_url($link).'" target="_blank" class="readmore"> '. esc_html( $label ) . '</a>';
                    ?>								
                </div>
			</div>
        <?php
