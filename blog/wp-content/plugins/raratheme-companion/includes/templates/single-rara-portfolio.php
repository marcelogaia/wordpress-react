...
while ( have_posts() ) : the_post(); 
    ...
    $image_size = apply_filters( 'rrtc_single_portfolio_image', 'full' ); ?>
    ...
    $args = apply_filters( 'rrtc_related_portfolio_args', array(
    ...
    $related_title = apply_filters( 'rrtc_related_portfolio_title', __( 'Related Projects', 'raratheme-companion' ) );
            ...
            <div class="portfolio-img-holder">
        		<?php 
                    while( $qry->have_posts() ){ 
                        $qry->the_post();
                        $related_image_size = apply_filters( 'rrtc_related_portfolio_image', 'full' );
